...
const ruZeroOneAi = {
  ...
  profLabel: "Профессия",
  learnMore: "Подробнее",
  heroEyebrow: "01AI.uz · от ML Community",
  joinCourseBtn: "Записаться на курс",
  heroStat1Label: "форматов обучения",
  heroStat2Label: "выпускников трудоустроены",
  heroStat3Label: "возврат денег",
  whyTitle: "Почему мы создали 01AI",
  formatsTitle: "Три пути в AI",
  advantagesTitle: "Почему выбирают 01AI",
  investorEyebrow: "Нас поддерживают",
  investorTitle: "Нас поддерживают",
  investorSubtitle: "Инвестор проекта",
  investorName: "Улугбек Исматов",
  investorRole: "Инвестор · MPMG",
  investorDesc: "Один из ведущих молодых специалистов Узбекистана в области стартапов, медиа и IT. Руководитель медиахолдинга MPMG, специализирующегося на создании качественного медиаконтента.",
  ctaTitle: "Начни учиться прямо сейчас",
  ctaSubtitle: "Первые скиллы — бесплатно. Без кредитных карт. Без предварительных знаний.",
  ctaNote: "✓ Бесплатные скиллы · ✓ Возврат денег · ✓ 2 сертификата",
  openPlatformBtn: "Открыть платформу 01AI.uz ↗",
  getConsultBtn: "Получить консультацию",
  ctaBtn: "Открыть платформу 01AI.uz",
  enrollBtn: "Записаться на курс",
  stat1Value: "3",
  stat1Label: "формата обучения",
  stat2Value: "70%",
  stat2Label: "выпускников трудоустроены",
  stat3Value: "100%",
  stat3Label: "возврат денег",
  whyText1: "AI и Data Science становятся основой любой профессии. Но качественного обучения на узбекском языке почти нет. Мы в ML Community видим это каждый день — на наших ивентах, хакатонах и встречах с сообществом.",
  whyText2: "Поэтому мы создали 01AI: платформу где можно начать с нуля, пройти путь до Junior-специалиста и получить реальный опыт в компаниях-партнёрах. Всё это на родном языке, в удобном темпе и с гарантией результата.",
  format1Title: "Скиллы",
  format1Badge: "БЕСПЛАТНО",
  format1Desc: "Короткие практические курсы от компаний-партнёров. SQL, Python, Excel, AI-инструменты. По окончании — цифровой бейдж в профиль.",
  format1Tag: "Начни прямо сейчас",
  format2Title: "Курсы",
  format2Badge: "ПОЛНЫЙ КУРС",
  format2Desc: "Полноценные курсы по Data Analytics, Data Engineering, Machine Learning. Выводят на уровень Junior-специалиста. Сертификат по окончании.",
  format2Tag: "Уровень: Junior",
  format3Title: "Профессии",
  format3Badge: "ПРЕМИУМ",
  format3Desc: "Интенсивная программа 5-6 месяцев с живыми занятиями, двумя международными сертификатами и стажировкой в компаниях-партнёрах.",
  format3Tag: "Возврат денег",
  featuresTitle: "Почему выбирают 01AI",
  feature1Title: "Живые занятия",
  feature1Desc: "Занятия в реальном времени через Telegram. Записи сохраняются навсегда.",
  feature2Title: "Два сертификата",
  feature2Desc: "Международный (IBM/Google) + аккредитованный AICA. Добавь в LinkedIn и резюме.",
  feature3Title: "Стажировка",
  feature3Desc: "Реальная практика в компаниях-партнёрах. 85% выпускников направлены на стажировку.",
  feature4Title: "Возврат денег",
  feature4Desc: "Завершил программу — получи 100% стоимости обратно. Это инвестиция, а не расходы.",
  feature5Title: "Поддержка ментора",
  feature5Desc: "Support teacher, support hours каждую неделю и мастер-классы в офисах партнёров.",
  feature6Title: "VibeCoin",
  feature6Desc: "VibeCoin — внутренняя валюта платформы. Зарабатывай за обучение, трать на бонусы.",
  tracks: [
...
const uzZeroOneAi = {
  ...
  profLabel: "Kasb",
  learnMore: "Ko'proq",
  heroEyebrow: "01AI.uz · ML Community'dan",
  joinCourseBtn: "Kursga yozilish",
  heroStat1Label: "o'qish formatlari",
  heroStat2Label: "bitiruvchilar ishga joylashgan",
  heroStat3Label: "pul qaytarish",
  whyTitle: "Nima uchun 01AI yaratdik",
  formatsTitle: "AI'ga uch yo'l",
  advantagesTitle: "Nima uchun 01AI?",
  investorEyebrow: "Bizni qo'llab-quvvatlovchilar",
  investorTitle: "Bizni qo'llab-quvvatlovchilar",
  investorSubtitle: "Loyiha investori",
  investorName: "Ulug'bek Ismatov",
  investorRole: "Investor · MPMG",
  investorDesc: "O'zbekistonning startaplar, media va IT sohasidagi yetakchi yosh mutaxassislaridan biri. Sifatli media kontent yaratishga ixtisoslashgan MPMG media holdingining rahbari.",
  ctaTitle: "Hoziroq o'rganishni boshlang",
  ctaSubtitle: "Birinchi skilllar — bepul. Kredit karta kerak emas. Oldindan bilim shart emas.",
  ctaNote: "✓ Bepul skilllar · ✓ Pul qaytarish · ✓ 2 sertifikat",
  openPlatformBtn: "01AI.uz platformasini ochish ↗",
  getConsultBtn: "Maslahat olish",
  ctaBtn: "Platformaga o'tish",
  enrollBtn: "Kursga yozilish",
  stat1Value: "3",
  stat1Label: "ta o'qish formati",
  stat2Value: "70%",
  stat2Label: "bitiruvchilar ishga joylashgan",
  stat3Value: "100%",
  stat3Label: "pul qaytarish",
  whyText1: "AI va Data Science har qanday kasb-hunarning asosiga aylanib bormoqda. Ammo o'zbek tilida sifatli ta'lim deyarli yo'q. Biz ML Community'da buni har kuni ko'rib turamiz — tadbirlarimizda, xakaton va hamjamiyat uchrashuvlarimizda.",
  whyText2: "Shuning uchun biz 01AI'ni yaratdik: noldan boshlash, Junior mutaxassis darajasiga yetish va hamkor kompaniyalarda real tajriba orttirish mumkin bo'lgan platforma. Bularning barchasi ona tilida, qulay sur'atda va natija kafolati bilan.",
  format1Title: "Skilllar",
  format1Badge: "BEPUL",
  format1Desc: "Hamkor kompaniyalardan qisqa amaliy kurslar. SQL, Python, Excel, AI vositalari. Yakunida — profilga raqamli badge.",
  format1Tag: "Hoziroq boshlang",
  format2Title: "Kurslar",
  format2Badge: "TO'LIQ KURS",
  format2Desc: "Data Analytics, Data Engineering, Machine Learning bo'yicha to'liq kurslar. Junior mutaxassis darajasiga olib chiqadi. Yakunida sertifikat.",
  format2Tag: "Daraja: Junior",
  format3Title: "Kasblar",
  format3Badge: "PREMIUM",
  format3Desc: "5-6 oylik intensiv dastur: jonli mashg'ulotlar, ikki xalqaro sertifikat va hamkor kompaniyalarda stajirovka.",
  format3Tag: "Pul qaytarish",
  featuresTitle: "Nima uchun 01AI?",
  feature1Title: "Jonli darslar",
  feature1Desc: "Telegram orqali real vaqtda darslar. Yozuvlar abadiy saqlanadi.",
  feature2Title: "Ikki sertifikat",
  feature2Desc: "Xalqaro (IBM/Google) + AICA akkreditatsiyasi. LinkedIn va rezyumengizga qo'shing.",
  feature3Title: "Amaliyot",
  feature3Desc: "Hamkor kompaniyalarda real amaliyot. Bitiruvchilarning 85% amaliyotga yo'naltirilgan.",
  feature4Title: "Pul qaytarish",
  feature4Desc: "Dasturni tugatdingiz — to'lovning 100% ini qaytarib oling. Bu xarajat emas, investitsiya.",
  feature5Title: "Mentor yordami",
  feature5Desc: "Har hafta support teacher, support hours va hamkor ofislarda master-klasslar.",
  feature6Title: "VibeCoin",
  feature6Desc: "VibeCoin — platforma ichki valyutasi. O'qish uchun ishlang, bonuslarga sarflang.",
  tracks: [
...
const enZeroOneAi = {
  ...
  heroEyebrow: "01AI.uz · by ML Community",
  joinCourseBtn: "Sign up for a course",
  heroStat1Label: "learning formats",
  heroStat2Label: "graduates employed",
  heroStat3Label: "money back guarantee",
  whyTitle: "Why we built 01AI",
  formatsTitle: "Three paths into AI",
  advantagesTitle: "Why choose 01AI",
  investorEyebrow: "Backed by",
  investorTitle: "Backed by",
  investorSubtitle: "Project investor",
  investorName: "Ulugbek Ismatov",
  investorRole: "Investor · MPMG",
  investorDesc: "One of Uzbekistan's leading young professionals in startups, media, and IT. Head of the MPMG media holding, specializing in quality media content.",
  ctaTitle: "Start learning right now",
  ctaSubtitle: "First skills are free. No credit card. No prior knowledge required.",
  ctaNote: "✓ Free skills · ✓ Money back · ✓ 2 certificates",
  openPlatformBtn: "Open 01AI.uz platform ↗",
  getConsultBtn: "Get consultation",
  ctaBtn: "Go to platform",
  enrollBtn: "Sign up for a course",
  stat1Value: "3",
  stat1Label: "learning formats",
  stat2Value: "70%",
  stat2Label: "graduates employed",
  stat3Value: "100%",
  stat3Label: "money back",
  whyText1: "AI and Data Science are becoming the foundation of every profession. But quality education in the Uzbek language is scarce. We at ML Community see this every day — at our events, hackathons, and community meetups.",
  whyText2: "That's why we built 01AI: a platform where you can start from zero, reach Junior level, and gain real experience at partner companies. All in your native language, at your own pace, with a results guarantee.",
  format1Title: "Skills",
  format1Badge: "FREE",
  format1Desc: "Short practical courses from partner companies. SQL, Python, Excel, AI tools. Finish and earn a digital badge for your profile.",
  format1Tag: "Start right now",
  format2Title: "Courses",
  format2Badge: "FULL COURSE",
  format2Desc: "Full courses in Data Analytics, Data Engineering, and Machine Learning. Take you to Junior level. Certificate upon completion.",
  format2Tag: "Level: Junior",
  format3Title: "Professions",
  format3Badge: "PREMIUM",
  format3Desc: "An intensive 5–6 month program with live classes, two international certificates and internship at partner companies.",
  format3Tag: "Money back",
  featuresTitle: "Why choose 01AI",
  feature1Title: "Live classes",
  feature1Desc: "Real-time classes via Telegram. Recordings saved forever.",
  feature2Title: "Two certificates",
  feature2Desc: "International (IBM/Google) + AICA accredited. Add to LinkedIn and your resume.",
  feature3Title: "Internship",
  feature3Desc: "Real practice at partner companies. 85% of graduates placed in internships.",
  feature4Title: "Money back",
  feature4Desc: "Complete the program — get 100% of your money back. It's an investment, not an expense.",
  feature5Title: "Mentor support",
  feature5Desc: "Support teacher, weekly support hours, and masterclasses at partner offices.",
  feature6Title: "VibeCoin",
  feature6Desc: "VibeCoin — the platform internal currency. Earn by learning, spend on bonuses.",
  tracks: [
...
const zhZeroOneAi = {
  ...
  profLabel: "职业",
  learnMore: "了解更多",
  heroEyebrow: "01AI.uz · 来自 ML Community",
  joinCourseBtn: "报名课程",
  heroStat1Label: "学习形式",
  heroStat2Label: "毕业生已就业",
  heroStat3Label: "退款保障",
  whyTitle: "我们为何创建 01AI",
  formatsTitle: "进入 AI 的三条路",
  advantagesTitle: "为何选择 01AI",
  investorEyebrow: "我们的支持者",
  investorTitle: "我们的支持者",
  investorSubtitle: "项目投资人",
  investorName: "乌卢别克·伊斯马托夫",
  investorRole: "投资人 · MPMG",
  investorDesc: "乌兹别克斯坦创业、媒体和IT领域领先的年轻专家之一，专注于优质媒体内容制作的MPMG媒体集团负责人。",
  ctaTitle: "立即开始学习",
  ctaSubtitle: "第一批技能免费。无需信用卡，无需基础。",
  ctaNote: "✓ 免费技能 · ✓ 退款保障 · ✓ 两张证书",
  openPlatformBtn: "打开 01AI.uz 平台 ↗",
  getConsultBtn: "获取咨询",
  ctaBtn: "前往平台",
  enrollBtn: "报名课程",
  stat1Value: "3",
  ...
  stat3Value: "100%",
  stat3Label: "退款保障",
  whyText1: "AI和数据科学正成为各行各业的基础。但用乌兹别克语讲授的优质课程几乎没有。我们在ML Community每天都能看到这一点——在我们的活动、黑客马拉松和社区会议上。",
  whyText2: "因此我们创建了01AI：一个可以从零开始、达到初级工程师水平、并在合作公司积累真实经验的平台。一切都用母语进行，节奏自由，并保证学习成果。",
  format1Title: "技能课",
  format1Badge: "免费",
  format1Desc: "来自合作公司的短期实践课程。SQL、Python、Excel、AI工具。完成后可获得数字徽章加入个人主页。",
  format1Tag: "立即开始",
  format2Title: "课程",
  format2Badge: "完整课程",
  format2Desc: "数据分析、数据工程、机器学习全套课程，帮助你达到初级工程师水平，完成后颁发证书。",
  format2Tag: "级别：初级",
  format3Title: "职业方向",
  format3Badge: "高级",
  format3Desc: "5-6个月强化项目，包含直播课程、两张国际证书和合作公司实习机会。",
  format3Tag: "退款保障",
  featuresTitle: "为何选择01AI",
  feature1Title: "直播课程",
  feature1Desc: "通过Telegram实时上课，录播永久保存。",
  feature2Title: "双重证书",
  feature2Desc: "国际认证（IBM/Google）+ AICA认证，可添加到LinkedIn和简历。",
  feature3Title: "实习机会",
  feature3Desc: "在合作公司进行真实实践，85%的毕业生获得实习机会。",
  feature4Title: "退款保障",
  feature4Desc: "完成课程即可退还100%费用，这是投资而非消费。",
  feature5Title: "导师支持",
  feature5Desc: "每周辅导教师、答疑时间及在合作伙伴办公室举办的大师班。",
  feature6Title: "VibeCoin",
  feature6Desc: "VibeCoin——平台内部货币。通过学习赚取，用于兑换奖励。",
  tracks: [
...
const ru = {
  ...
  aiRewind: {
    title: 'AI Rewind',
    badge: '🎬 Ежегодный итоговый ивент MLC',
    subtitle: 'Спикеры. Тренды. Сообщество.',
    desc: 'Ежегодный итоговый ивент ML Community. Собираем лучших спикеров, разбираем главные тренды уходящего года в AI и смотрим что ждёт нас дальше. Это не просто лекции — это живая дискуссия, нетворкинг и атмосфера где AI-сообщество Узбекистана встречается вместе.',
    descFallback: 'Ежегодный итоговый ивент ML Community. Собираем лучших спикеров, разбираем главные тренды уходящего года в AI и смотрим что ждёт нас дальше. Это не просто лекции — это живая дискуссия, нетворкинг и атмосфера где AI-сообщество Узбекистана встречается вместе.',
    statEditions: 'выпуск',
    statAttendees: 'участников',
    statSpeakers: 'спикеров',
    sectionSpeakers: 'Спикеры',
    sectionPartners: 'Партнёры',
    sectionSources: 'Источники',
    sectionDescription: 'О мероприятии',
    noPhotos: 'Фотографии скоро появятся',
    back: '← Сообщество',
  },
  mlGap: {
    back: '← Сообщество',
...
const uz = {
  ...
  aiRewind: {
    title: 'AI Rewind',
    badge: "🎬 MLC'ning yillik yakuniy tadbiri",
    subtitle: "Spikerlari. Trendlar. Hamjamiyat.",
    desc: "ML Community'ning yillik yakuniy tadbiri. Eng yaxshi spikerlari to'playmiz, o'tgan yilning asosiy AI trendlarini tahlil qilamiz va kelajakka nazar tashlaymiz. Bu shunchaki ma'ruzalar emas — bu jonli muhokama, networking va O'zbekiston AI hamjamiyati birgalikda uchrashuvining muhiti.",
    descFallback: "ML Community'ning yillik yakuniy tadbiri. Eng yaxshi spikerlari to'playmiz, o'tgan yilning asosiy AI trendlarini ko'rib chiqamiz va kelajakka nazar tashlaymiz. Bu shunchaki ma'ruzalar emas — jonli muhokama, networking va O'zbekiston AI hamjamiyatining birgalikdagi uchrashuvidir.",
    statEditions: 'nashr',
    statAttendees: 'ishtirokchi',
    statSpeakers: 'spiker',
    sectionSpeakers: 'Spikerlari',
    sectionPartners: 'Hamkorlar',
    sectionSources: 'Manbalar',
    sectionDescription: 'Tadbir haqida',
    noPhotos: 'Rasmlar tez orada',
    back: '← Hamjamiyat',
  },
  mlGap: {
    back: '← Hamjamiyat',
    editions: 'nashr',
    attendees: 'ishtirokchi',
    sectionSpeakers: 'Spikerlari',
    sectionPartners: 'Hamkorlar',
    sectionSources: 'Manbalar',
    sourceLabel: 'Manba',
    noSpeakers: "Spikerlari ko'rsatilmagan",
    noPhotos: 'Rasmlar tez orada',
    yearLabel: 'yil',
  },
  partnerMeetups: {
...
const en = {
  ...
  aiRewind: {
    title: 'AI Rewind',
    badge: '🎬 Annual MLC closing event',
    subtitle: 'Speakers. Trends. Community.',
    desc: "ML Community's annual closing event. We bring together the best speakers, review the key AI trends of the year, and look ahead. This is not just lectures — it's a live discussion, networking, and an atmosphere where Uzbekistan's AI community comes together.",
    descFallback: "ML Community's annual closing event. We bring together the best speakers, review the key AI trends of the year, and look ahead. This is not just lectures — it's a live discussion, networking, and an atmosphere where Uzbekistan's AI community comes together.",
    statEditions: 'edition',
    statAttendees: 'attendees',
    statSpeakers: 'speakers',
    sectionSpeakers: 'Speakers',
    sectionPartners: 'Partners',
    sectionSources: 'Sources',
    sectionDescription: 'About the event',
  ...
  nav: { about: "About", community: "Community", educationGroup: "Education", productsGroup: "Services", education: "Education", individualEdu: "Individual", corporateEdu: "Corporate", b2b: "B2B", development: "Development", aiMedia: "AI for media", platform: "Platform", menu: "Open menu" },
...
const zh = {
  ...
  aiRewind: {
    ...
    badge: '🎬 MLC年度收官活动',
    subtitle: '演讲者。趋势。社区。',
    desc: 'ML Community年度收官活动。我们汇聚最优秀的演讲者，回顾这一年的主要AI趋势，展望未来。这不仅仅是讲座——这是一场充满活力的讨论、社交活动，也是乌兹别克斯坦AI社区共聚一堂的时刻。',
    descFallback: 'ML Community年度收官活动。我们汇聚最优秀的演讲者，回顾这一年的主要AI趋势，展望未来。这不仅仅是讲座——这是一场充满活力的讨论、社交活动，也是乌兹别克斯坦AI社区共聚一堂的时刻。',
    statEditions: '期',
    statAttendees: '参与者',
    statSpeakers: '演讲者',
    sectionSpeakers: '演讲者',
  ...
  nav: { about: "关于我们", community: "社区", educationGroup: "教育", productsGroup: "服务", education: "教育", individualEdu: "个人课程", corporateEdu: "企业课程", b2b: "B2B", development: "开发", aiMedia: "AI 媒体", platform: "平台", menu: "打开菜单" },
